...
public class LogicalAndExpr implements Expr {
	...
	public LogicalAndExpr(int _Line, Expr _LeftHand, Expr _RightHand)
	{
		LeftHand = _LeftHand;
	...
	public TypeDescriptor getResultType(Env e) throws ExpressionParsingException {
		...
		if(!(LeftHand.getResultType(e).equals(BooleanType.Instance)))
			throw new ExpressionParsingException("Logical AND expression can be applied only to boolean values, and left-hand is a type of \"" + LeftHand.getResultType(e) + "\".", this.getLine() );

		if(!(RightHand.getResultType(e).equals(BooleanType.Instance)))
			throw new ExpressionParsingException("Logical AND expression can be applied only to boolean values, and right-hand is a type of \"" + RightHand.getResultType(e) + "\".", this.getLine() );
...
String code = ";!!begin LogicalOrExpr:\n";
		...
		code += retval + " = and " + typename + " " + LHvalue + ", " + RHvalue + "\n";

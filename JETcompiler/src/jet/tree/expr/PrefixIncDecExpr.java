...
public class PrefixIncDecExpr implements Expr {

	private final int Line;
	private final String Operator;
	private final Expr Target;
	
	public PrefixIncDecExpr(int _Line, String _operator, Expr _target)
	{
		Operator = _operator;
		Target = _target;
		Line = _Line;
	...
	public TypeDescriptor getResultType(Env e) throws ExpressionParsingException {
		...
		if(!(TargetType.equals(IntegerType.Instance)))
			throw new ExpressionParsingException("Cannot apply prefix inc/dec operator to type " + TargetType, this.getLine());
	...
	public CResult compute(CEnv e) throws ComputationException {
		String code = ";!!begin PrefixIncDecExpr:\n";
